...
public class Scale extends AbstractScale {
	...
	public static final Scale DIMINISHED_HALFTONE_WHOLETONE = new Scale("diminished halftone-wholetone",
	...
	public static final Scale SIX_TONE_SYMMETRICAL = new Scale("six tone symmetrical",
	...
	public Scale(String name, Interval[] intervals, Note root) {
		...
		if (scaleCatalog == null)
			scaleCatalog = new HashMap<String, Scale>();
		if (!scaleCatalog.containsKey(name))
			scaleCatalog.put(name, this);
	}
